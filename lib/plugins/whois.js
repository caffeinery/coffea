        ...
        irc.on('data', function (msg, stream_id) {
            ...
            case 'ERR_NEEDMOREPARAMS':
                ...
                if (cb) {
                    ...
                    utils.emit(irc, stream_id, 'whois', {"error": "Not enough parameters"});
                }
                break;
            case 'ERR_NOSUCHSERVER':
                ...
                if (cb) {
                    ...
                    utils.emit(irc, stream_id, 'whois', {"error": "No such server"});
                }
                break;
            case 'ERR_NOSUCHNICK':
                params = msg.params.split(' ');
                ...
                if (cb) {
                    ...
                    utils.emit(irc, stream_id, 'whois', {"error": "No such nick/channel"});
                }
                break;
            }
        });
