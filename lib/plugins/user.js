...
User.prototype.whois = function (fn) {
    // TODO: we should put this.network at the beginning everywhere
    this.client.whois(this.network, this.getNick(), fn);
};
    ...
    return function (irc) {
        ...
        irc.getUser = function (nick, stream_id) {
            ...
            var user = _.find(userCache, function (usr) {
                return (usr.getNick() === nick) && (user.getNetwork() === stream_id);
            });
            if (user === undefined) {
